    ...
    const noteRows = notes.map(note => {
        ...
        return (
            <tr key={note.id.toString()} className={classes}>
                ...
                <td className="align-middle">{note.id}</td>
                <td className="align-middle">{note.data.item.name}</td>
                <td className="align-middle">{note.data.item.location}</td>
            ...
            <table className="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th className="align-middle text-center">Location</th>
                    </tr>
                </thead>
                <tbody>
                    {noteRows}
